...
//if use of DMA of sam3x DUE, put SPI cl at max frequency (master clock(84MHz)/2)... speed test hhaev to be done...
#if defined(USE_SPI_DMA) && defined( _SAM3X8E_)
#define SPI_ETHERNET_SETTINGS SPISettings(48000000, MSBFIRST, SPI_MODE0)
#else
// Safe for all chips
...
#ifndef ethernetDMA_h_
#error "EthernetDMA.h must be included before w5100.h"
#endif
